...
public class Lesson7_1_Main_Activity extends AppCompatActivity {
    //private static final String TAG = "[HomeWork][Lesson7][1]";
     ...
     */
    private Lesson7_1_NotificationHelper mNotificationHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            Toast.makeText(Lesson7_1_Main_Activity.this,"Please upgrade to Android Oreo.", Toast.LENGTH_LONG).show();
        }else{
            setContentView(R.layout.activity_lesson7_1);
            mNotificationHelper = new Lesson7_1_NotificationHelper(this);
            mUIModel = new MainUi(findViewById(R.id.activity_lesson7_1));
        }
    }
